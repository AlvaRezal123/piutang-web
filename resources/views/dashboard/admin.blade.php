...
<div class="bg-white rounded-3xl p-8 shadow-sm border border-purple-100">
    <div class="flex items-start justify-between gap-4">
        ...
        <a href="/admin/backup/source-code"
           class="flex items-center gap-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 px-4 py-2.5 rounded-xl font-semibold text-sm transition">
        ...
        <a href="/admin/backup/database"
           class="flex items-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-700 px-4 py-2.5 rounded-xl font-semibold text-sm transition">
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
    ...
    <div class="relative overflow-hidden rounded-2xl p-5 shadow-sm" style="background: linear-gradient(135deg, #6C5CE7 0%, #5628C7 100%);">
        ...
        <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-4" style="background: rgba(250,204,21,0.15);">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" style="color: #FACC15;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <div class="absolute bottom-0 left-0 right-0 h-1 rounded-b-2xl" style="background: #FACC15;"></div>
    </div>
...
<div class="grid md:grid-cols-3 gap-6 mt-8">
    ...
    <div class="bg-white rounded-3xl p-6 border border-purple-100 shadow-sm">
        <h2 class="font-bold text-lg text-gray-800 flex items-center gap-2">
            <i class="ti ti-user-check text-[#5628C7]"></i>
            Validasi Agen
        </h2>
        <p class="text-gray-500 mt-2">
            Periksa dan validasi pendaftaran agen baru.
        </p>
        <a href="/agen" class="inline-block mt-5 bg-[#5628C7] text-white px-5 py-3 rounded-xl font-semibold">
            Buka Menu →
        </a>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 border border-purple-100 shadow-sm">
        <h2 class="font-bold text-lg text-gray-800 flex items-center gap-2">
            <i class="ti ti-cash text-[#5628C7]"></i>
            Pencairan Saldo
        </h2>
        <p class="text-gray-500 mt-2">
            Kelola pencairan hutang yang telah disetujui
        </p>
        <a href="/admin/pencairan" class="inline-block mt-5 bg-[#5628C7] text-white px-5 py-3 rounded-xl font-semibold">
            Buka Menu →
        </a>
    </div>
    ...
    <div class="bg-white rounded-3xl p-6 border border-purple-100 shadow-sm">
        <h2 class="font-bold text-lg text-gray-800 flex items-center gap-2">
            <i class="ti ti-credit-card text-[#5628C7]"></i>
            Validasi Pembayaran
        </h2>
        <p class="text-gray-500 mt-2">
            Validasi bukti pembayaran yang dikirim agen.
        </p>
        <a href="/admin/pembayaran" class="inline-block mt-5 bg-[#5628C7] text-white px-5 py-3 rounded-xl font-semibold">
            Buka Menu →
        </a>
    </div>
...
<div class="grid md:grid-cols-2 gap-6 mt-8">
    ...
    <div class="bg-white rounded-3xl p-6 border border-purple-100 shadow-sm">
        <div class="flex items-center gap-3 mb-6">
            <div class="w-8 h-8 rounded-xl bg-purple-100 flex items-center justify-center">
                <i class="ti ti-clipboard-list text-[#5628C7]"></i>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-3">
                <div class="w-10 h-10 rounded-2xl bg-purple-50 flex items-center justify-center flex-shrink-0">
                    {!! $item['icon'] !!}
                </div>
                <div class="flex-1">
    ...
    <div class="bg-white rounded-3xl p-6 border border-purple-100 shadow-sm">
        <div class="flex items-center gap-3 mb-6">
            <div class="w-8 h-8 rounded-xl bg-purple-100 flex items-center justify-center">
                <i class="ti ti-file-text text-[#5628C7]"></i>
            </div>
...
<div
    id="passwordModalTrigger"
    data-open="{{ $errors->any() || session('error') || session('success') ? '1' : '0' }}"
    class="hidden">
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var trigger = document.getElementById('passwordModalTrigger');
        var shouldOpenPasswordModal = trigger.dataset.open === '1';
