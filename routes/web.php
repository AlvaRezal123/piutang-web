...
use App\Http\Controllers\PeriodeCicilanController;
...
Route::get('/admin/backup/source-code', [BackupController::class, 'backupSourceCode']);
Route::get('/admin/backup/database', [BackupController::class, 'backupDatabase']);
...
Route::post('/agen/ajukan-cicilan', [AgenController::class, 'ajukanCicilan']);
Route::get('/owner/approval-cicilan', [AgenController::class, 'approvalCicilan']);
Route::get('/owner/approval-cicilan/setujui/{id}', [AgenController::class, 'setujuiCicilan']);
Route::post('/owner/approval-cicilan/tolak/{id}', [AgenController::class, 'tolakCicilanAkses']);

Route::get('/admin/periode-cicilan',[PeriodeCicilanController::class, 'index']);
Route::post('/admin/periode-cicilan/store',[PeriodeCicilanController::class, 'store']);
Route::post('/admin/periode-cicilan/update/{id}',[PeriodeCicilanController::class, 'update']);
Route::get('/admin/periode-cicilan/delete/{id}',[PeriodeCicilanController::class, 'destroy']);
