...
{
    //untuk menampilkan halaman login sebagai halaman autentikasi bagi seluruh pengguna sistem.
    public function index()
    {
        return view('login');
    }

    //mengarahkan pengguna ke dashboard sesuai dengan role yang dimiliki.
    ...
    //menampilkan form/modal lupa password
